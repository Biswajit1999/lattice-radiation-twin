...
- Euclid Tier C transfer: conditional release kernels use committed mission-specific timing and literature timescales. Captured fractions, species weights and timescale multipliers are fixed simulation scenarios, never observations or posterior draws. The result cannot be indexed by mission date until an observational damage amplitude is identified.
